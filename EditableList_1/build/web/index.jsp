...
<%@page import="lt.bit.data1.Person"%>
<%@page import="lt.bit.data1.Record"%>
                    ...
                    <div id="myModalE<%=p.getId()%>" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="edit">
                                ...
                                Birth year:<input name="by" value="<%=p.getBirthYear()%>">
                                Birth month:<input name="bm" value="<%=p.getBirthMonth()%>">
                                Birth day:<input name="bd" value="<%=p.getBirthDay()%>">
        ...
        <div id="myModal" class="modal">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="add">
                    ...
                    Birth year:<input class="in" name="by" placeholder="1900">
                    Birth month:<input class="in" name="bm" placeholder="01">
                    Birth day:<input class="in" name="bd" placeholder="01">
