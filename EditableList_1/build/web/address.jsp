...
<%@page import="lt.bit.data1.Address"%>
...
<body>
    ...
    <h1>Person <%=Record.getPerson(iddd).getFirstName()%> <%=Record.getPerson(iddd).getLastName()%> addresses are: </h1>
    ...
    <table>
        ...
        <%            for (Address a : Record.getPersonAddresses(iddd)) {
        %>
        <tr>
            <th><%=a.getId()%></th>
            <th><%=a.getAddress()%></th>
