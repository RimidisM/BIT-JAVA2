 ...
 * @author rimid
 */
@WebServlet(name = "UppdateContact", urlPatterns = {"/uppdatecontact"})
public class UppdateContact extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (typ.length() > 2 && 2 < con.length()) {
                ...
                DB.updateContact(conn, ids, typ, con);
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UppdateContact.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
