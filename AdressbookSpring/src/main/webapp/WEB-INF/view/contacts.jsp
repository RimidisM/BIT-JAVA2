...
<body>
    ...
    <%
        ...
        List<Contact> l = (List<Contact>) request.getAttribute("listContacts");
        Person p = (Person) request.getAttribute("personName");
       
    %>

    <h1>Person <%=p.getFirstName()%> <%=p.getLastName()%> contacts are: </h1>
            ...
            <th class="record-settings">
                ...
                <div id="myModalE<%=a.getId()%>" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <form style="text-align: right" method="POST" action="backToContactList">
                            <input type="hidden" value="<%=iddd%>" name="id">
